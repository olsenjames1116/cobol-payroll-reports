      ...
      *      separated and subtotaled by region and department.
       ...
       01   DeptCount   Pic 99.
       01   RegionTotalNum     Pic 9(9)V99.
       01   RegionCount Pic 99.
       01   RegionLine.
            05               Pic X(2) Value spaces.
            05               Pic X(12) Value "Region:     ".
            05  RegionNumStr Pic X(2).
            05               Pic X(2) Value ": ".
            05  RegionNameStr Pic X(15).
       01   RegionTotal.
            05               Pic X(100) Value spaces.
            05               Pic X(7) Value "Region ".
            05  RegionNumTot Pic X(2).
            05               Pic X(18) Value " Total Payroll:   ".
            05  RegionSubTot Pic $$$,$$$,$$9.99.
       01   CurrentReg  Pic X(2).
       01   PastReg     Pic X(2).
       01   NewRegStr   Pic X.
       ...
       200-Process.
            Move RegionNum to CurrentReg

            If Not (CurrentReg = PastReg)
                ...
                Perform 710-ControlRegion
                Move DeptNum to PastDept
                Move RegionNum to PastReg
            Else
                Move EmpNum to EmpNoStr
                Move LastName to EmpLName
                Move FirstName to EmpFName
            ...
            Compute RegionTotalNum = RegionTotalNum + ExpPayAmt
       ...
       760-NewRegion.
            ...
            Move RegionNum to RegionNumStr
            Move RegionName to RegionNameStr
            Write ReportRecord from RegionLine
                after advancing 1 line
            Write ReportRecord from BlankLine
                after advancing 1 line
            Add 2 to LineNo
       ...
       830-PrintRegTotal.
            ...
            If RegionCount > 1
                Move PastReg to RegionNumTot
                Move RegionTotalNum to RegionSubTot
                Write ReportRecord from RegionTotal
                    after advancing 1 line
                Write ReportRecord from BlankLine
                    after advancing 1 line
                Add 2 to LineNo
