      *      James Olsen
      *      This program takes in a payroll file and returns it with control breaks by department.
      *      It also uses a table to search each person's school code a produce their school tax rate.
       ...
       File-Control.
           Select PayrollFile
                Assign to "lab7a-in.dat"
                Organization is line sequential.
           Select SchoolTax
                Assign to "lab7a-schooltax.dat"
                Organization is line sequential.
           Select PayrollReport
                Assign to "lab7a-out.dat"
                Organization is line sequential.
       ...
       FD  SchoolTax.
       01  SchoolTaxes.
           05   STSchoolCode  Pic X(3).
           05   STSchoolTaxRate Pic V999.
       FD  PayrollReport.
       01  ReportRecord     Pic X(153).
       ...
       01   DeptCount   Pic 99.
       01   SchoolTaxAmt Pic 9(5)V99.
       78   TableLimit Value is 25.
       01   SchoolTable.
            05  SchoolEntry occurs TableLimit times indexed by Indx.
                10  SchoolCode  Pic X(3).
                10  SchoolTaxRate   Pic V999.
       01   TableSize   Pic 9(2) Value 0.
       01   EndOfSchoolFile Pic X Value "N".
       01   SchoolTaxNum.    
            05              Pic X(3) Value spaces.
            05 SchoolNumStr Pic $$,$$9.99.
       ...
       000-Main.
           ...
           Perform 850-Final
           Close PayrollFile PayrollReport SchoolTax
           Stop Run.
       ...
       160-MakeTable.
            Perform until EndOfSchoolFile = "Y"
                Read SchoolTax
                    At end 
                        Move "Y" to EndOfSchoolFile
                    Not at end
                        Add 1 to TableSize
                        If TableSize > TableLimit
                            Perform 170-ExceededTaxTable
                            Exit Perform
                        End-if
                        Move SchoolTaxes to SchoolEntry(TableSize)
                End-Read
            End-perform.
            
       170-ExceededTaxTable.
            Display "Data too large for table".
       ...
       625-ComputeSchool.
            If SchoolDist = "   "
                Move 0 to SchoolNumStr
                Move SchoolTaxNum to SchoolTaxStr
                Exit paragraph
            End-if
            ...
            Search SchoolEntry
                At end 
                    Perform 630-SchoolError
                When SchoolCode(Indx) = SchoolDist
                    Compute SchoolTaxAmt Rounded = SchoolTaxRate(Indx)
                    *ExpPayAmt
                    Move SchoolTaxAmt to SchoolNumStr
                    Move SchoolTaxNum to SchoolTaxStr
                    Compute ExpPayAmt = ExpPayAmt - SchoolTaxAmt
            End-search.
       
       630-SchoolError.
            Move "  **********" to SchoolTaxStr.
